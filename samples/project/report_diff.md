...
Generated by scitech-librarian 3.6.0 (report level: simple). Every number below is reproducible from the archived research directory `lit`.
...
| Filters | since=2026-09-07, sources=all, diff=True |
...
|---|---|---|---|---|---|---|---|
| NOV | 0 | 0 | 0 | - | 0 | 0 | 0 |
| MLP | 478 | 139 | 0 | - | 617 | 0 | 317 |
| PSC | 4579 | 176 | 0 | 8 | 4,763 | 0 | 483 |
| QC | 154 | 418 | 17 | - | 589 | 0 | 438 |
| Total | 5,211 | 733 | 17 | 8 | 5,969 | 0 | 1238 |
...
| (n = 5,961)                              |     | automation tools (venue filter) (n = 36) |
| openalex: 5,211                          | --> | duplicates removed (n = 0)               |
| arxiv: 733                               |     +------------------------------------------+
| inspire: 17                              |
+------------------------------------------+
...
SCREENING
+------------------------------------------+     +------------------------------------------+
| Records screened (n = 1,238)             | --> | Records excluded (n = --)                |
+------------------------------------------+     +------------------------------------------+
                      |
                      v
+------------------------------------------+     +------------------------------------------+
...
|   citation | 8 |
| Records retrieved (downloaded / ingested) | 36 |
...
| 9 | Limits and restrictions | record download capped at 300 per block and backend, most-cited first; no date, language or document-type limits applied; report filters: since=2026-09-07, sources=all, diff=True |
...
| 14 | Peer review | none |
| 15 | Total records | 5,961 identified from databases, 8 via other methods; 36 retrieved; 1,238 unique |
...
| Growth Mechanism and Origin of High $sp^3$ Content in Tetrahedral Amorphous Carbon | Miguel A. Caro; Volker L. Deringer; Jari Koskinen et al. | 2018 | Phys. Rev. Lett. 120, 166101 (2018) | 178 | [10.1103/PhysRevLett.120.166101](https://doi.org/10.1103/PhysRevLett.120.166101) | 8.602 (2026) |
| Constructing first-principles phase diagrams of amorphous LixSi using machine-learning-assisted sampling with an evolutionary algorithm | Nongnuch Artrith; Alexander Urban; Gerbrand Ceder | 2018 | The Journal of Chemical Physics 148 (24), 241711 2018 | 155 | [10.1063/1.5017661](https://doi.org/10.1063/1.5017661) | 4.245 (2026) |
...
| Localization and delocalization of light in photonic moire lattices | Peng Wang; Yuanlin Zheng; Xianfeng Chen et al. | 2020 | Nature 577, 42-46(2020) | 483 | [10.1038/s41586-019-1851-6](https://doi.org/10.1038/s41586-019-1851-6) | 18.721 (2026) |
...
| Simulating non-Hermitian quasicrystals with single-photon quantum walks | Quan Lin; Tianyu Li; Lei Xiao et al. | 2021 | Phys. Rev. Lett. 129, 113601 (2022) | 139 | [10.1103/PhysRevLett.129.113601](https://doi.org/10.1103/PhysRevLett.129.113601) | 8.602 (2026) |
...
| Bose-Einstein Condensates in Optical Quasicrystal Lattices | Laurent Sanchez-Palencia; Luis Santos | 2005 | Physical Review A 72 (2005) 053607 | 117 | [10.1103/PhysRevA.72.053607](https://doi.org/10.1103/PhysRevA.72.053607) | 2.886 (2026) |
...
- openalex: 36 of 36 records (100%) came from non-curated venues and were filtered; its raw count overstates the curated literature by about that much.
