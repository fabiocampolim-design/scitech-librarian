...
Generated by scitech-librarian 3.2 (report level: simple). Every number below is reproducible from the archived run directory `20260828T160426`.
...
| (n = 5,705)                              |     | automation tools (venue filter) (n = 37) |
| openalex: 4,961                          | --> | duplicates removed (n = 60)              |
| arxiv: 727                               |     +------------------------------------------+
| inspire: 17                              |
+------------------------------------------+
                      |
...
SCREENING
+------------------------------------------+     +------------------------------------------+
| Records screened (n = 1,226)             | --> | Records excluded (n = --)                |
+------------------------------------------+     +------------------------------------------+
                      |
                      v
+------------------------------------------+     +------------------------------------------+
