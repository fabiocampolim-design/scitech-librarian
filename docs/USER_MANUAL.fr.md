...
rien à installer : copiez les fichiers, remplissez `.env`, écrivez
...
n'ont besoin ni de clé ni d'institution.
...
journaux d'audit ; une suite de tests hors ligne (294 vérifications) et CI.
